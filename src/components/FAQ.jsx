...
const FAQ = () => {
  return (
    <section className="relative z-20 overflow-hidden bg-gradient-to-r from-blue-400 to-blue-200 py-20 dark:from-gray-900 dark:to-gray-800">
      <div className="container mx-auto px-4">
        <div className="mb-12 text-center">
          <span className="mb-2 block text-2xl font-semibold text-black-600 dark:text-blue-400">
            FAQ
          </span>
        ...
        <div className="-mx-4 flex flex-wrap">
          <div className="w-full px-4 lg:w-1/2">
            ...
            />
            <AccordionItem
              header="What is Glucose?"
              text="A simple sugar and the primary source of energy for the body's cells, obtained from the foods we eat or produced by the body itself."
            />
            <AccordionItem
              header="What is Cholesterol?"
              text="A waxy, fat-like substance that's essential for bodily functions but high levels can increase the risk of certain health conditions. Normal total cholesterol levels are below 200 mg/dL, with bad LDL cholesterol ideally below 100 mg/dL and good HDL cholesterol ideally above 60 mg/dL."
            />
          </div>
          <div className="w-full px-4 lg:w-1/2">
            <AccordionItem
            ...
            />
             <AccordionItem
              header="What is Insulin?"
              text="A hormone produced by the pancreas that plays a crucial role in regulating blood sugar levels by allowing glucose from the bloodstream to enter cells for energy."
            />
          </div>
        </div>
      </div>
