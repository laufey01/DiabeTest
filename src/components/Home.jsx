  ...
  return (
    <div className="overflow-x-hidden">
      ...
      <div className="container mx-auto my-8 px-4">
        ...
        <div className="flex flex-col md:flex-row gap-10 bg-gradient-to-r from-blue-400 to-blue-200 justify-around items-center mb-8 md:mx-10 border p-4 rounded-md">
          <motion.div
          ...
          <motion.div
            ...
            className="md:w-2/3 md:pl-8 bg-white-100 p-4 rounded-md"
          >
        ...
        <div className="flex flex-col gap-10 md:flex-row-reverse justify-around bg-gradient-to-l from-blue-400 to-blue-200 items-center mb-8 md:mx-10 border p-4 rounded-md">
          <motion.div
            initial={{ opacity: 0, x: -150 }}
            whileInView={{ opacity: 1, x: 0 }}
            viewport={{ once: true }}
          ...
          <motion.div
            ...
            className="md:w-1/2 md:pr-8 bg-white-100 p-4 rounded-md"
          >
            <h3 className="text-xl font-bold mb-2 text-blue-600">
              Prediction
            </h3>
        ...
        <div className="flex flex-col md:flex-row gap-10 justify-around bg-gradient-to-r from-blue-400 to-blue-200 items-center mb-8 md:mx-10 border p-4 rounded-md">
          <motion.div
            initial={{ opacity: 0, x: -150 }}
            whileInView={{ opacity: 1, x: 0 }}
            viewport={{ once: true }}
          ...
          <motion.div
            ...
            className="md:w-1/2 md:pl-8 bg-white-100 p-4 rounded-md"
          >
            <h3 className="text-xl font-bold mb-2 text-blue-600">
              Visualization
            </h3>
