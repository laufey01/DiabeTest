...
import HoursofSleep from "../assets/plots/HoursofSleep.png";
import cholesterol from "../assets/plots/cholesterol.png";
  ...
  return (
    <div className="container mx-auto py-8 text-center">
      <motion.h1
        ...
        className="text-3xl font-bold mb-6 text-blue-500 text-center border-b-2 p-2"
      >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        ...
        >
          <h2 className="text-xl font-bold mb-4 text-blue-600">Age Plot</h2>
          <img
            src={agePlot}
        ...
        <motion.div
          ...
          className="bg-gray-100 p-4 rounded-lg shadow-md"
        >
          <h2 className="text-xl font-bold mb-4 text-blue-600">BMI Plot</h2>
          <img
            src={BMIPlot}
            alt="BMI vs Age"
            className="mx-auto w-full h-64 object-cover rounded-lg cursor-pointer"
        ...
        <motion.div
          ...
          className="bg-gray-100 p-4 rounded-lg shadow-md"
        >
          <h2 className="text-xl font-bold mb-4 text-blue-600">Blood Pressure Plot</h2>
          <img
        ...
        <motion.div
          ...
          className="bg-gray-100 p-4 rounded-lg shadow-md"
        >
          <h2 className="text-xl font-bold mb-4 text-blue-600">Diabetes Pedigree Function Plot</h2>
          <img
            src={DPF}
            alt="Residual Plot"
            className="mx-auto w-full h-64 object-cover rounded-lg cursor-pointer"
        ...
        <motion.div
          ...
          className="bg-gray-100 p-4 rounded-lg shadow-md"
        >
          <h2 className="text-xl font-bold mb-4 text-blue-600">Glucose Plot</h2>
          <img
            src={glucose}
            alt="Residual Plot"
            className="mx-auto w-full h-64 object-cover rounded-lg cursor-pointer"
        ...
        <motion.div
          ...
          className="bg-gray-100 p-4 rounded-lg shadow-md"
        >
          <h2 className="text-xl font-bold mb-4 text-blue-600">Insulin Plot</h2>
          <img
            src={insulin}
            alt="Residual Plot"
            className="mx-auto w-full h-64 object-cover rounded-lg cursor-pointer"
        ...
        <motion.div
          ...
          className="bg-gray-100 p-4 rounded-lg shadow-md"
        >
          <h2 className="text-xl font-bold mb-4 text-blue-600">Pregnancies Plot</h2>
          <img
            src={pregnancies}
            alt="Residual Plot"
            className="mx-auto w-full h-64 object-cover rounded-lg cursor-pointer"
        ...
        <motion.div
          ...
          className="bg-gray-100 p-4 rounded-lg shadow-md"
        >
          <h2 className="text-xl font-bold mb-4 text-blue-600">Skin Plot</h2>
          <img
            src={skin}
            alt="Residual Plot"
            className="mx-auto w-full h-64 object-cover rounded-lg cursor-pointer"
        ...
        <motion.div
          ...
          className="bg-gray-100 p-4 rounded-lg shadow-md"
        >
          <h2 className="text-xl font-bold mb-4 text-blue-600">Hours of Sleep Plot</h2>
          <img
            src={HoursofSleep}
            alt="Residual Plot"
            className="mx-auto w-full h-64 object-cover rounded-lg cursor-pointer"
            onClick={() => openModel(HoursofSleep)}
          />
        </motion.div>
        ...
        <motion.div
          ...
          className="bg-gray-100 p-4 rounded-lg shadow-md"
        >
          <h2 className="text-xl font-bold mb-4 text-blue-600">Cholesterol Plot</h2>
          <img
            src={cholesterol}
            alt="Residual Plot"
            className="mx-auto w-full h-64 object-cover rounded-lg cursor-pointer"
            onClick={() => openModel(cholesterol)}
          />
        </motion.div>
      </div>
