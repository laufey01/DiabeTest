...
import logo_final from "../assets/logo_final.jpg";
...
const Navbar = () => {
  ...
  return (
    <nav className="bg-gradient-to-r from-blue-400 to-blue-200 sticky z-50 top-0" style={{ height: "5rem" }}>
        ...
        <div className="flex items-center justify-between h-20">
          <div className="flex items-center">
            <Link to="/" className="text-white font-bold flex items-center">
              ...
              <span className="ml-2">DiabeTest</span>
            </Link>
          </div>
      ...
      {/* Mobile Menu */}
      <div
        className={`fixed top-0 right-0 h-full bg-gray-100 bg-opacity-90 z-50 transform ${
        ...
        <div className="px-4 pt-5 pb-3 space-y-4">
          <div className="flex justify-between items-center">
            ...
            <button
              onClick={toggleMenu}
              type="button"
              className="bg-gray-700 inline-flex items-center justify-center p-2 rounded-md text-gray-200 hover:text-white hover:bg-white-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 focus:ring-white"
            >
              <FaTimes className="block h-6 w-6" />
            </button>
          </div>
...
const NavLink = ({ to, children, onClick }) => (
  <Link
    to={to}
    onClick={onClick}
    className="block text-gray-600 hover:bg-blue-400 hover:text-white px-3 py-2 rounded-md text-base font-medium"
  >
    {children}
  </Link>
);
